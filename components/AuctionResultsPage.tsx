    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex gap-2">
          <button className="px-3 py-2 rounded-lg border border-slate-300 text-sm" onClick={() => navigate(`/admin/auction-results/${summary.auction.id}/acceptances`)}>Acceptance Dashboard</button>
          <button className="px-3 py-2 rounded-lg border border-slate-300 text-sm" onClick={() => navigate(`/admin/auction-results/${summary.auction.id}/alternate-queue`)}>Alternate Queue</button>
          <button className="px-3 py-2 rounded-lg border border-slate-300 text-sm" onClick={() => navigate('/admin/analytics/alternate-queue')}>Queue Analytics</button>
                      ...
                      <td className="px-2 py-2 text-right">
                        <div className="inline-flex gap-1">
                          ...
                          <button className="px-2 py-1 rounded bg-blue-600 text-white text-xs" onClick={() => {
                            ...
                            navigate(`/admin/contracts/${contractId}/review`);
