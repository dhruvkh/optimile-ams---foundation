                    ...
                    <tr className="border-t border-slate-100 hover:bg-slate-50">
                      ...
                      <td className="px-4 py-3 text-right">
                        <div className="inline-flex gap-1">
                          ...
                          {q.queueStatus === 'FAILED' && <button className="px-2 py-1 rounded bg-red-600 text-white text-xs" onClick={() => navigate(`/admin/auction-results/${auctionId}/failed-awards/${q.laneId}`)}>Take Action</button>}
                        </div>
                      </td>
                    </tr>
                    {expanded === q.laneId && (
