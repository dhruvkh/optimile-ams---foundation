  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-5 space-y-4">
      <div className="flex items-start justify-between gap-3">
        <div>
          <button
            ...
            onClick={() => navigate(`/admin/live-auctions/${vm.auction.id}`)}
          >
            {vm.auction.name}
          </button>
      ...
      <div className="flex flex-wrap gap-2">
        <button onClick={() => navigate(`/admin/live-auctions/${vm.auction.id}`)} className="px-3 py-2 rounded-lg bg-blue-600 text-white text-sm font-medium hover:bg-blue-700">View Details</button>
                  ...
                  return (
                    <tr key={vm.auction.id} className="border-t border-slate-100 hover:bg-slate-50">
                      <td className="px-4 py-3">
                        <button onClick={() => navigate(`/admin/live-auctions/${vm.auction.id}`)} className="font-semibold text-slate-900 hover:text-blue-700">{vm.auction.name}</button>
                      ...
                      <td className="px-4 py-3 text-right">
                        <div className="inline-flex gap-2">
                          ...
                          <button className="p-2 rounded border border-slate-300 hover:bg-slate-100" onClick={() => navigate(`/admin/live-auctions/${vm.auction.id}`)} title="Open details">
                            <Eye size={14} />
                          </button>
                        </div>
                      </td>
