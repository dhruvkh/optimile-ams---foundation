    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 text-sm">
          <Link to={`/admin/auction-results/${summary.auction.id}/alternate-queue`} className="text-blue-700 hover:underline">Alternate Queue</Link>
          <Link to={`/admin/auction-results/${summary.auction.id}`} className="text-blue-700 hover:underline">Back to Results</Link>
        </div>
      </div>
