...
export function LiveAuctionDetail() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      navigate(`/admin/auction-results/${auctionId}`);
    }, 1200);
    ...
    <div className="space-y-6">
      <div className="space-y-3">
        <div className="text-sm text-slate-500">
          <Link to="/admin/live-auctions" className="hover:text-blue-700">Live Auctions</Link> &gt; {auction.name}
        </div>
