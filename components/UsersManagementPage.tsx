    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Link to="/admin/settings/roles-permissions" className="inline-flex items-center gap-2 rounded-lg bg-[#00C853] px-4 py-2 text-sm font-semibold text-white"><Users size={15} /> Roles</Link>
        </div>
      </div>
