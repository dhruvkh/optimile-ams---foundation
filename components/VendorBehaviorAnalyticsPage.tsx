    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex gap-2">
          ...
          <Link to="/admin/analytics/vendor-insights" className="px-3 py-2 rounded border border-slate-300 text-sm">Open Insights Dashboard</Link>
          <Link to="/admin/settings/vendor-analytics" className="px-3 py-2 rounded border border-slate-300 text-sm">Settings</Link>
        </div>
      </div>
