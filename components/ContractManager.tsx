    ...
    return (
        <div>
            <div className="mb-6 flex items-center justify-between gap-3">
                ...
                <Link to="/admin/contracts/import" className="px-3 py-2 rounded border border-slate-300 text-slate-700 text-sm">
                    Import Contracts
                </Link>
            </div>
                        ...
                        {contracts.map(c => (
                            <tr key={c.id}>
                                ...
                                <td className="px-6 py-4 text-right">
                                    <Link 
                                        to={c.status === ContractStatus.DRAFT ? `/contract/preview/${c.id}` : `/contract/${c.id}`} 
