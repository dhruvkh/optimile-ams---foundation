    ...
    <div className="space-y-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex gap-2 text-sm">
          ...
          <Link to={`/admin/auction-results/${auctionId}`} className="px-3 py-2 rounded border border-slate-300 inline-flex items-center gap-1">Results <ExternalLink size={14} /></Link>
        </div>
      </div>
