    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link to="/admin/vendors" className="px-3 py-2 rounded border border-slate-200 text-slate-700 text-sm">Back to Vendors</Link>
          <Link to="/admin/vendors/bulk-import" className="px-3 py-2 rounded bg-blue-600 text-white text-sm">Import Vendors</Link>
        </div>
      </div>
