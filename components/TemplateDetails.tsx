...
export const TemplateDetails: React.FC = () => {
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
            ...
            <button
              ...
              onClick={() => navigate('/admin/auction-templates')}
            >
              Back to Templates
            </button>
          </div>
  ...
  const handleDuplicate = () => {
    ...
    navigate(`/admin/auction-templates/${newTemplateId}`);
  };

  const handleDelete = () => {
    try {
      auctionEngine.deleteTemplate(template.templateId);
      navigate('/admin/auction-templates');
    } catch (err) {
  ...
  const handleEdit = () => {
    navigate(`/admin/auction-templates/${template.templateId}/edit`);
  };
