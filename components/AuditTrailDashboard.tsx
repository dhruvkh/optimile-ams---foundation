    ...
    <div className="space-y-5 pb-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="rounded-xl p-4 text-slate-900" style={{ backgroundColor: '#76FF03' }}>
          ...
          <Link to="/admin/settings/active-sessions" className="mt-2 inline-block rounded bg-slate-900/80 px-2 py-1 text-xs text-white">View Sessions</Link>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Link to="/admin/audit-alerts" className="rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700">Audit Alerts</Link>
        <Link to="/admin/settings/audit-retention" className="rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700">Retention Policy</Link>
      </div>
                          ...
                          <div className="grid gap-4 lg:grid-cols-2">
                            ...
                            <div className="space-y-2 text-xs">
                              ...
                              <div className="flex flex-wrap gap-2">
                                ...
                                <Link to="/admin/audit-alerts" className="inline-flex items-center gap-1 rounded border border-slate-300 px-2 py-1"><AlertTriangle size={12} /> Create Alert</Link>
                              </div>
                            </div>
                          </div>
                        </td>
